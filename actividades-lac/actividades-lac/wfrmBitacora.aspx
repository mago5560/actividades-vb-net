<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="wfrmBitacora.aspx.vb" Inherits="actividades_lac.wfrmBitacora" %>
			...
			<div class="card-body">
				<div class="table-responsive">
					<asp:GridView class="table table-bordered" ID="grdDatos" Width="100%" runat="server"
						...
						<Columns>
						<asp:BoundField DataField="IDBITACORA" HeaderText="Linea" SortExpression="IDBITACORA" />
							<asp:BoundField DataField="IDACTIVIDAD" HeaderText="Id Actividad" SortExpression="IDACTIVIDAD" />
